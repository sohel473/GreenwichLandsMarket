<x-layout>
  ...
  <div class="container py-md-5 container--narrow">
    ...
    <div class="tab-content" id="pills-tabContent">
            ...
            <div class="list-group">
              @foreach ($customers as $customer)
                <div class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                  ...
                  <div>
                    <a href="#" class="text-info me-2" data-toggle="tooltip" data-placement="top" title="View">
      ...
      <!-- Pictures Tab -->
      <div class="tab-pane fade {{ $activeTab == 'pictures' ? 'show active' : '' }}" id="pills-contact"
        role="tabpanel" aria-labelledby="pills-contact-tab">
        <!-- Add Picture Button -->
        <div class="text-center">
          <a href="#" class="btn btn-sm btn-outline-primary mb-2">Add Picture</a>
          <a href="#" class="btn btn-sm btn-outline-success mb-2">Download
            Pictures
            Report</a>
          <div class="text-center">
            <form action="/admin" method="GET">
              <input type="text" name="picture_search" class="form-control d-inline-block mb-2"
                style="width: 50%;" placeholder="Search Pictures by name, description">
              <button type="submit" class="btn btn-sm btn-primary">Search</button>
            </form>
          </div>
        </div>
